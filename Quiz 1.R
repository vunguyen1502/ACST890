...
bondprice <- function (C,F,y,n) {#Name the function "bondprice" with C, F, y, n as input
  P = (sum(C*exp(-y*c(1:n))))+(F*exp(-y[n]*n)) #This is the code for the formula given in question 1
...
summary(gdp.exp)
#The F-statistic and p-value provide concrete proof against null hypothesis.
